...
Patch5:         %{name}-debug.patch
# Cause tests to pass with tcsh
Patch6:         %{name}-csh.patch

BuildRequires:  tcl-devel, tclx-devel, pkgconfig(x11)
...
%check
make test MODULEPATH=$RPM_BUILD_ROOT%{_sysconfdir}/modulefiles
